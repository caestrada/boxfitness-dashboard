...
export const PROFILE_AVATAR_ACCEPT = PROFILE_AVATAR_ALLOWED_MIME_TYPES.join(",")
...
export function getProfileAvatarFileExtension(fileName: string, mimeType: string) {
...
export function getProfileAvatarStoragePath(avatarUrl: string | null, supabaseUrl: string) {
  if (!avatarUrl) {
    return null
  }
