    ...
    <Card>
      <CardHeader className="space-y-3">
        ...
        <CardDescription className="max-w-xl leading-7">
          Start with the gym name. The URL slug is generated automatically so
          the workspace can be selected immediately after creation.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <form action={formAction} className="space-y-6">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            ...
            <div className="app-subpanel p-4">
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Used in the dashboard switcher
              </p>
            </div>
            <div className="app-subpanel p-4">
            ...
            <div className="app-subpanel flex items-start gap-3 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-muted-foreground">
                  Members, classes, billing, and analytics can be rebuilt on top
                  of this workspace without carrying legacy route debt.
                </p>
              </div>
            </div>
            <div className="app-subpanel flex items-start gap-3 p-4">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-muted-foreground">
                  The new workspace appears inside the authenticated shell as
                  soon as the action succeeds.
                </p>
              </div>
            </div>
          </div>
